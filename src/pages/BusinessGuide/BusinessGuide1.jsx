...
const projectData = [
  { label: "사업명", value: "이편한세상 성성호수공원" },
  { label: "사업위치", value: "충청남도 천안시 서북구 업성동 465-6번지 일원" },
  { label: "대지면적", value: "93,237㎡" },
  { label: "건축규모", value: "지하3층 ~ 지상 39층, 13개동" },
  { label: "세대수", value: "총 1,763세대(일반분양 1,498세대 / 임대 265세대)" },
  { label: "주차대수", value: "2,729대 (세대당 1.55대)" },
];
